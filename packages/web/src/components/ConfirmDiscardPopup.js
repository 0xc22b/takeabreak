...
import { updatePopupUrlHash, hideEditor } from '../actions';
import { CONFIRM_DISCARD_POPUP, SM_WIDTH } from '../types/const';
...
const ConfirmDiscardPopup = () => {
  ...
  const onConfirmDiscardOkBtnClick = () => {
    if (didClick.current) return;
    setTimeout(() => dispatch(hideEditor()), 100);
              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    Are you sure you want to discard your unsaved changes? All of your changes will be permanently deleted. This action cannot be undone.
                  </p>
                </div>
              </div>
            </div>
